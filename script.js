...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // ✅ Show updated success overlay message
            const successContent = successOverlay.querySelector('.success-content h2');
            const successParagraph = successOverlay.querySelector('.success-content p');
            successContent.textContent = "Registration Successfully!";
            successParagraph.textContent = "Just Fataa!!";
